...
function pack(packConfig){
    ...
    o.build = function(){
        return co(function*(){
            ...
            yield o.addPlugin();
            yield o.buildExtras();
            yield o.addAndroidKey();
            yield o.buildRelease();
            yield o.copyApkFile();
    ...
    o.targetPath = packConfig.apkDownloadLink;
    ...
    o.getSvn = function() {
        return new Promise(function (resolve, reject) {
            ...
            console.log(o.projectDir);
            o.emptyDir(o.projectDir);
            console.log(fs.existsSync(o.projectDir));
            // if(fs.existsSync(o.projectDir)){
            //     console.log('rm -r ' + o.projectDir + '/*');
            //     var ls = child.exec('rm -r ' + o.projectDir + '/*', function (error, stdout, stderr) {
            //         if (error) {
            //             console.log(error.stack);
            //             console.log('Error code: '+error.code);
            //         }
            //         console.log('清理'+o.projectDir+'文件夹成功');
            //     });
            // }
            ...
            //     }
                client.checkout(o.projectSvn,function(err, data) {
                    if(err){
                        reject(new Error(err))
                    }
                    resolve(data);
    ...
    o.addPlatform = function (){
        return new Promise(function (resolve, reject) {
            console.log(process.cwd());
            console.log('platform add begin');
            cordova.platform('add', o.platform,{'verbose': true},function (err, data) {
                if (err) {
                    reject(new Error(err))
                }
    ...
    o.removePlatform = function(){
        return new Promise(function (resolve, reject) {
            cordova.platform('remove', 'android',function (err, data) {
                if (err) {
                    reject(new Error(err))
                }
                resolve(data);
    ...
    o.addAndroidKey = function(){
        return new Promise(function (resolve, reject) {
            var json = {
                ...
                //        "provisioningProfile": "fdbc7ec6-4320-4203-abc7-e36921a7ae23",
                //    },
                //    "release": {
    ...
    o.buildRelease = function(){
        return new Promise(function (resolve, reject) {
            console.log('开始build')
            var buildType = o.appBuildType == 'release'?true:false;
            cordova.build({platforms:[o.platform],options:{"release":buildType,"silent":false}},function (err, data) {
                if (err) {
                    reject(new Error(err))
                }
                resolve(data);
    ...
    o.copyApkFile = function(){
        return new Promise(function (resolve, reject) {
            var src = 'platforms/android/build/outputs/apk/android-' + o.appBuildType + '.apk';
            console.log(o.targetPath);
            var dest = o.targetPath;
