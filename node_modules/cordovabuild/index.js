...
var cordova = require('cordova-lib').cordova,
    ...
    //ConfigParser  = require('cordova_lib').ConfigParser;
...
function pack(cfg){
    ...
    o.listPlatform = function(){
        console.log('list platform begin, dir:',process.cwd());
        return new Promise(function (resolve, reject) {
            cordova.platform('ls', function (err, data) {
                if (err) {
                    reject(new Error(err))
                }
                console.log('list platform','success');
                resolve(data);
            });
        });
    };
            ...
            cordova.plugin('ls',function(err,data){
                ...
                if( data.length != 0){
                    cordova.plugin('remove', data,function (err, data) {
                        ...
                        console.log('plugin add ','success');
                        resolve(data);
                    });
                }else {
                    resolve('no plugin');
...
//TODO 2.修改config.xml access cdvfile: & ios scroll
//TODO 3.更改图标
